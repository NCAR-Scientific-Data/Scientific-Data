...
import uuid
import sys
sys.path.insert(1,'C:/Users/Bobby/College Senior/Senior Projects/Scientific-Data/tangelo_html/ncarworkflow/python')
...
def createWorkflow():
	...
	#A.setWorkflowID(1234)
	#B.setWorkflowID(1234)
	w.add(A)
	w.add(B)
	w.setWorkflowID('1234')
	print (w())
createWorkflow()